...
DROP TABLE IF EXISTS users, cars,tires,parts,reservations CASCADE;
...
insert into cars ( manufacturer, model, make_year,last_service) values ('Bmw', 'm3', '2020','2020-06-16');
insert into cars ( manufacturer, model, make_year,last_service) values ('seat', 'ibiza', '2020','2020-08-16');
insert into cars ( manufacturer, model, make_year,last_service) values ('Mazda', 'mx5', '2020','2020-09-16');
insert into cars ( manufacturer, model, make_year,last_service) values ('Volvo', 'c1', '2020','2020-06-18');
...
insert into reservations (full_name, manufacturer, res_date, description,address) values ('Amirfahoum','tires service','2020-10-16','X2 tires Maxis R1 with dimention 120/115','nazareth 110');
