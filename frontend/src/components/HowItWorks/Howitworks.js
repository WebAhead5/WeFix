    ...
    return (
      <div className="howitworks-container">
        ...
        <p>
          ...
          convenient service. Scheduling Your Appointment is Easy HERE IS WHAT
          WE NEED 1. What you think is wrong (e.g., "my car is shaking" or "I
          need new brakes") 2. The year, make, and model of your car 3. Your
          name, email address, phone number, and zip code. GET A FAIR AND
          TRANSPARENT PRICE We’ll provide a detailed list of the parts,
          services, and costs needed to service your car. In most cases, we will
          provide a fair and transparent price instantly. All our mechanics have
          agreed to honor the quotes we provide. This ensures that there will be
          no need for negotiations or any last minute surprises.
        </p>
      </div>
    );
  }
