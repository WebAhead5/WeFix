  ...
  render() {
    return (
      <div className="TiersPage">
        ...
        <div className="Form1">
          <p>
            WeFix would like to thank you for using our services, a confirmation
            was sent to your e-mail address, with all details about the deal.
            For any Questions or Feedback, feel free to contact us at:
            Email:wefix@gmail.com Mobile:05482827044
          </p>
        </div>
      </div>
    );
